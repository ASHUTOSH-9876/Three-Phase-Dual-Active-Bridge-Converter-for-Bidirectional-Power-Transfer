...
5. To check bridge losses, check **Measure_inverter_power_output** and **Measure_rectifier_power_input** Subsystems.  
6. For powerflow from Battery_2 to Battery_1 set input Delay_2 = 0 and Delay_1 between (0,25ms). Follow Step 4 and 5.  
...
-Rated Capacity (in Ah): 20
-Initial State-of-charge: 80%
-Battery Response Time (in sec): 0.01 

Battery_2:
 -Type: Lithium-Ion
-Nominal Voltage (in V): 44
-Rated Capacity (in Ah): 20
-Initial State-of-charge: 40% 
-Battery Response Time (in sec): 0.01  

Isolation Transformer: - Units: (pu) 
-Nominal power and frequency [Pn(VA), fn(Hz)]: [1e3, 1e4] 
-Winding 1 parameters [V1 Ph-Ph(Vrms), R1(pu), L1(pu)]: [230, 0.003, 0.01] 
-Winding 2 parameters [V2 Ph-Ph(Vrms), R2(pu), L2(pu)]: [230, 0.003, 0.01] 
-Magnetization resistance Rm (pu): 500 
-Magnetization inductance Lm (pu): 200 
-Saturation characteristic [i1, phi1; i2, phi2; ...] (pu): [0 0; 0.0024 1.2; 1 1.52] 

Triggering Pulse to g1: -Pulse type: Time based 
...
Triggering Pulse to g3: 
-Pulse type: Time based 
-Time (t): Use simulation time 
-Amplitude: 1
-Period (secs): 5e-5
-Pulse Width (% of period): 50 
-Phase delay (secs): (5e-5)/3 

Triggering Pulse to g5: 
-Pulse type: Time based 
-Time (t): Use simulation time 
-Amplitude: 1 
-Period (secs): 5e-5 
...
Triggering Pulse to g4: 
-Pulse type: Time based 
-Time (t): Use simulation time 
-Amplitude: 1 
-Period (secs): 5e-5 
-Pulse Width (% of period): 50 
-Phase delay (secs): (5e-5)/2 

Triggering Pulse to g6: 
-Pulse type: Time based 
-Time (t): Use simulation time 
-Amplitude: 1 
-Period (secs): 5e-5 
-Pulse Width (% of period): 50 
-Phase delay (secs): -(5e-5)/6 

Triggering Pulse to g2: 
-Pulse type: Time based 
-Time (t): Use simulation time 
-Amplitude: 1 
-Period (secs): 5e-5 
...
-Resistance (in Ohms): 1e-2 
-Inductance (in H): 40e-6 
